...
class Main(QMainWindow):
    ...
    def c_input(self):
        self.in_file_path, file_type = QFileDialog.getOpenFileName(self, "选取文件", ".", "Text Files (*.txt)")
        self.ui.input.show()
        self.ui.input.setText(self.in_file_path)

    def c_output(self):
        self.out_file_path, file_type = QFileDialog.getOpenFileName(self, "选取文件", ".", "Text Files (*.txt)")
        self.ui.output.show()
